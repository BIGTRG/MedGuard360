...
INSERT INTO eligibility_checks (id, patient_id, state_code, payer_id, coverage_type, source, active,
                                effective_from, plan_name, details, checked_at, ttl_until, requested_by) VALUES
...
INSERT INTO clinical_encounters (id, patient_id, provider_id, state_code, encounter_type, status,
                                 started_at, completed_at, pa_request_ids, claim_ids, created_by) VALUES
...
INSERT INTO claims (id, claim_control_number, patient_id, billing_provider_id, rendering_provider_id,
                    ...
                    total_charge_cents, status, fraud_score, fraud_recommendation, created_by) VALUES
  ('40000000-0000-0000-0000-000000000001', '260515-000001',
   '10000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   '20000000-0000-0000-0000-000000000001', 'NC_MEDICAID', 'NC', '837P',
   CURRENT_DATE - 7, CURRENT_DATE - 7, ARRAY['E11.9'], 12500, 'submitted', 15, 'auto_pay',
   '00000000-0000-0000-0000-000000000003'),
  ('40000000-0000-0000-0000-000000000002', '260515-000002',
   '10000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001',
   '20000000-0000-0000-0000-000000000001', 'NC_MEDICAID', 'NC', '837P',
   CURRENT_DATE - 3, CURRENT_DATE - 3, ARRAY['J45.909'], 9500, 'paid', 8, 'auto_pay',
   '00000000-0000-0000-0000-000000000003'),
  ('40000000-0000-0000-0000-000000000003', '260515-000003',
   ...
   '20000000-0000-0000-0000-000000000001', 'NC_MEDICAID', 'NC', '837P',
   CURRENT_DATE - 1, CURRENT_DATE - 1, ARRAY['I10'], 18000, 'fraud_review', 82, 'route_to_review',
   '00000000-0000-0000-0000-000000000003')
ON CONFLICT (id) DO NOTHING;

INSERT INTO claim_lines (id, claim_id, line_number, service_code, service_code_type, units,
                         charge_cents, diagnosis_pointers, service_date, place_of_service) VALUES
...
VALUES
  (gen_random_uuid(), '40000000-0000-0000-0000-000000000003', 'NC', 82, 'route_to_review',
...
INSERT INTO fraud_cases (id, claim_id, state_code, status, opened_at) VALUES
...
INSERT INTO pa_requests (id, patient_id, ordering_provider_id, payer_id, state_code, service_code,
                         ...
                         decision_explanation, ai_engine_version, ai_match_score, due_at, created_by) VALUES
  ('70000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001',
   ...
   'MRI brain w/o contrast', ARRAY['G44.1'], 'standard', 'evaluating',
   '2 of 3 criteria met; documentation of failed conservative treatment required.',
   'pa-nlp-v1.0', 0.67, now() + interval '7 days', '00000000-0000-0000-0000-000000000003'),
...
INSERT INTO denials (id, claim_id, state_code, carc_code, carc_description, rarc_codes,
  ...
  ('90000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000002', 'NC',
   ...
   9500, now() - interval '1 day', 'Service requires prior authorization', 'appealing',
   now() + interval '60 days')
ON CONFLICT (id) DO NOTHING;

INSERT INTO appeals (id, denial_id, attempt_number, status, drafted_by_ai, ai_engine_version,
                     ai_confidence, subject, body, attachments) VALUES
...
INSERT INTO crisis_plans (id, patient_id, state_code, created_by_provider_id, warning_signs,
                          ...
                          emergency_contacts, safe_environment_steps, effective_from, status) VALUES
...
INSERT INTO crisis_alerts (id, patient_id, state_code, source, severity, signals, detected_at, status) VALUES
...
INSERT INTO hub_calls (id, state_code, caller_type, intent, channel, duration_seconds, fraud_flag, crisis_flag) VALUES
...
INSERT INTO dme_orders (id, patient_id, prescribing_provider_id, supplier_provider_id, payer_id,
                       ...
                       cmn_complete, date_of_service, status, created_by) VALUES
  (gen_random_uuid(), '10000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000001',
   ...
   1, 'rental', 27500, true, CURRENT_DATE - 1, 'approved', '00000000-0000-0000-0000-000000000003');

INSERT INTO nemt_trips (id, patient_id, broker_id, payer_id, state_code, hcpcs_code, trip_type,
                       pickup_address, destination_address, scheduled_pickup_at, miles_billed, status, created_by) VALUES
  (gen_random_uuid(), '10000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000002',
   'NC_MEDICAID', 'NC', 'A0130', 'one_way', '34 Spruce Ct, Asheville NC', '789 Hospital Dr, Asheville NC',
...
INSERT INTO pharmacy_claims (id, patient_id, pharmacy_user_id, ndc_code, drug_name, quantity,
                              days_supply, fill_date, payer_id, state_code, total_amount, status, created_by) VALUES
...
INSERT INTO hie_referrals (id, fhir_resource_id, patient_id, referring_provider_id, receiving_org_name,
                          state_code, service_requested, priority, status, fhir_payload, created_by) VALUES
  (gen_random_uuid(), 'ServiceRequest/demo-001', '10000000-0000-0000-0000-000000000001',
   ...
   'Cardiology consult — chest pain workup', 'routine', 'active',
