...
if ($token) {
  ...
  $portalPaths = @("/compliance", "/compliance/hets", "/reporting", "/billing", "/fraud/cases", "/fraud/rings", "/state/claims", "/state/credentialing", "/state/fraud", "/state/perm", "/state/engagement", "/admin/users", "/provider/pa", "/pa-queue/decided", "/provider/encounters", "/provider/patients", "/credentialing", "/dme", "/nemt", "/responder", "/pharmacy", "/pharmacy/drug-pa", "/hie", "/biometric", "/patient/benefits", "/patient/engagement", "/school", "/school/students")
