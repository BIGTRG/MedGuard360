...
if ($token) {
  ...
  $portalPaths = @("/compliance", "/reporting", "/fraud/cases", "/fraud/rings", "/state/claims", "/state/credentialing", "/admin/users", "/provider/pa", "/pa-queue/decided", "/provider/encounters", "/credentialing", "/dme", "/nemt")
