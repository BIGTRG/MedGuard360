...
CREATE TABLE notification_templates (
  ...
  subject TEXT,
  body_template TEXT NOT NULL,  -- handlebars-style {{variable}} placeholders
...
CREATE INDEX notif_logs_user_idx ON notification_logs(recipient_user_id);
CREATE INDEX notif_logs_status_idx ON notification_logs(status);
